...
const encryptPassword = process.env.ETH_ENCRYPT_PASSWORD;
...
// console.log("firstEncrypt: ", firstEncrypt);
// console.log("secondEncrypt: ", secondEncrypt);
// console.log("wallet: ", wallet);
// console.log("firstDecrypt: ", firstDecrypt);
// console.log("secondDecrypt: ", secondDecrypt);
...
async function sendAndTrackTransaction(senderPrivateKey, receiverAddress) {
  try {
    ...
    if (tx.transactionHash) {
        ...
        const status = checkBscScan.data.result.isError === '0' ? 'Success' : 'Fail';
        if(status == 'Success') {
...
const senderPrivateKey = "0x8a07d2d230dcb97272576b6a4f8841f06cf4b865a9d6e241925287421bd57b00"; // Thay bằng private key của ví gửi
const receiverAddress = "0x59772e95C77Dd1575fB916DACDFabEF688cc7971"; // Thay bằng địa chỉ ví nhận

sendAndTrackTransaction(senderPrivateKey, receiverAddress);
...
//     crypto: {
//       ciphertext: 'beb145739ece1715fa3af2e190f784ab381856caf890bad75d9a947c650d47d6',
